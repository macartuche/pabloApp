...
public class reporteMasVendido extends javax.swing.JPanel {
    ...
    private void printBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printBTNActionPerformed
        ...
        String reportPath = "/Users/macbookpro/pabloApp/src/ventanas/reportes/jasper/masVendidoReport.jasper";
...
//            filtro.put("criteria", criteria + "%");
            Query q = controller.getEntityManager().createQuery("select count(b.quantity), b.productId.name , sum(b.totalWithTax) "
                    + " from DetailBilling b "
...
//        dBTable1.createControlPanel();
        ...
        for (DetailBilling detail : details) {
            detail.setName(detail.getProductId().getName());
        }
        fijarDatos(details);
    }
